...
# EasyAdapter rules
-keepclassmembers class * extends sunny.easyadapter.ItemViewHolder {
    public <init>(...);
 }
...
-keepclassmembers class mvpzhihu.data.model.** {
...
-keepclassmembers class mvpzhihu.data.remote.RibotsService$** {
    !static !private <fields>;
}
