...
/**
 * The type Long comment fragment.
...
public class LongCommentFragment extends BaseFragment {
    ...
    public static LongCommentFragment newInstance(int commentId) {
    ...
    public void initViews(Bundle savedInstanceState) {
        ...
        loadLongComment(commentId);
    }

    private void loadLongComment(int commentId) {
        mDataManager.getLongComments(commentId)
                ...
                .subscribe(new Subscriber<List<Comment>>() {
                    ...
                    public void onError(Throwable e) {
                        LogUtil.e(e, "加载LongComment数据出错。");
                        showLongCommentEmpty();
                    }
    ...
    private void showLongCommentEmpty() {
    ...
    private void showLongComment(List<Comment> comments) {
